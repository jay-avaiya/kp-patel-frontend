...
const CardRight = ({ title, color, image1, image2, text }) => {
  return (
    <>
      <div className="w-full h-fit md:h-[317px] lg:h-[476px]  xl:h-[694px] md:px-10 lg:px-14 xl:px-[60px]">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-4 md:gap-6 lg:gap-14 xl:gap-18">
          {/* desktop */}
          <div className="hidden md:flex flex-col items-center text-end md:items-end md:justify-end md:mr-10 mt-18 md:py-10 md:mt-0 space-y-7 ">
            <h3
          ...
          <div className="relative w-full flex justify-center md:justify-normal md:-rotate-y-180">
            <img
              src={image1}
              alt={image1}
              className="
