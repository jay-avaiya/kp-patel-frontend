...
//       <div className="py-16 flex flex-col items-center space-y-26">
//         {/* Title */}
//         <div className="flex flex-col space-y-10 text-center">
//           <h3 className="text-[#FF5500] text-5xl font-semibold font-montserrat">
//             About the School
//           </h3>
//           <p className="text-[24px] max-w-[1120px]">
...
//           <p className="text-xl text-end max-w-[220px]">
//             Kantaben Manilal Patel Primary School was established with the
//             belief that education is the most powerful tool to shape young minds
//             and communities.
//           </p>
...
//             <p className="text-xl max-w-[220px]">
//               Kantaben Manilal Patel Primary School was established with the
